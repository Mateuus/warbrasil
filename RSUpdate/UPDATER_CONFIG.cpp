...
char	UPDATER_VERSION[512]     = "1.0.1";
...
char	GAME_TITLE[512]          = "War Brasil. Battlezone";

// updater (xml and exe) and game info on our server.
char	UPDATE_DATA_URL[512]     = "http://localhost/wo/wo.xml";	// url for data update
char	UPDATE_UPDATER_URL[512]  = "http://localhost/wo/updater/woupd.xml";

// HIGHWIND CDN
char	UPDATE_UPDATER_HOST[512] = "http://localhost/wo/updater/";
// PANDO CDN
...
char	EULA_URL[512]            = "https://alocalhost/TOS.rtf";
char	GETSERVERINFO_URL[512]   = "https://localhost/wo/api_getserverinfo3.xml";
