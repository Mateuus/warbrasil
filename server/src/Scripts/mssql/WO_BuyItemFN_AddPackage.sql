USE [gameid_v1]
GO
/****** Object:  StoredProcedure [dbo].[WO_BuyItemFN_AddPackage]    Script Date: 05/31/2011 16:17:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[WO_BuyItemFN_AddPackage]
...
BEGIN
	...
	--IsEnabled will be checked in GetPrice	
