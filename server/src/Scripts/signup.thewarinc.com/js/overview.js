function ShowVideo(VideoID) {
	...
	document.getElementById('YouTubePlayer').innerHTML = "<iframe class='youtube-player' type='text/html' width='640' height='385' src='http://www.youtube.com/embed/" + VideoID + "' frameborder='0'></iframe>";
