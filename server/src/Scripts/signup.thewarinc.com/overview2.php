...
<img src="images/Play1.png" style="margin-left: 0px;" border="0" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Register1','','images/Play2.png',1)" id="Register1" name="Register1" ></a>
		...
		<div style="position: relative; top: 0px; left: 0px; width: 100%; z-index: 100" align="center" >
			...
			<!--Table Top-->
			<div style="position: relative; top: 0px; left: 0px; width: 778px; height: 463px; background:url('images/MenuBG_Top2b.png') no-repeat; z-index: 2;" >
...
-->
			...
			<!--Table Mid-->
			<div style="position: relative; top: 0px; left: 0px; width: 778px; background:url('images/MenuBG_Mid2b.png') repeat-y; z-index: 2;" >
					...
					echo "
							<div style=\"position: relative; float: left; width: 160px; height: 90px; z-index: 11;\">
								...
								<div style=\"position:absolute; top:1px; left:1px; z-index: 17;\">
								  <a href=\"Media/Weapons/Weap_Wall_Render_01.jpg\" rel=\"lightbox[media]\" onmouseout=\"unhighlightPic('Border$i')\" onmouseover=\"highlightPic('Border$i')\"><img src=\"images/blank.gif\" width=\"140\" height=\"90\" border=\"0\"  ></a>
								</div>
								...
								<div style=\"position:absolute; top:0px; left:0px; z-index: 13;\">
								  <img src=\"Media/Weapons/Weap_Wall_Render_01_resize.jpg\" width=\"140\" height=\"84\" class=\"myImages\" name=\"Image$i\" id=\"Image$i\" >
								</div>
						...
						echo "
							<div style=\"position: relative; float: left; width: 160px; height: 90px; z-index: 11;\">
								...
								<div style=\"position:absolute; top:1px; left:1px; z-index: 17;\">
								  <a href=\"Media/Weapons/Weap_Wall_Render_02.jpg\" rel=\"lightbox[media]\" onmouseout=\"unhighlightPic('Border$i')\" onmouseover=\"highlightPic('Border$i')\"><img src=\"images/blank.gif\" width=\"140\" height=\"90\" border=\"0\"  ></a>
								</div>
								...
								<div style=\"position:absolute; top:0px; left:0px; z-index: 13;\">
								  <img src=\"Media/Weapons/Weap_Wall_Render_02_resize.jpg\" width=\"140\" height=\"84\" class=\"myImages\" name=\"Image$i\" id=\"Image$i\" >
								</div>
						...
						echo "
							<div style=\"position: relative; float: left; width: 160px; height: 90px; z-index: 11;\">
								...
								<div style=\"position:absolute; top:1px; left:1px; z-index: 17;\">
								  <a href=\"Media/Weapons/Weap_Wall_Render_03.jpg\" rel=\"lightbox[media]\" onmouseout=\"unhighlightPic('Border$i')\" onmouseover=\"highlightPic('Border$i')\"><img src=\"images/blank.gif\" width=\"140\" height=\"90\" border=\"0\"  ></a>
								</div>
								...
								<div style=\"position:absolute; top:0px; left:0px; z-index: 13;\">
								  <img src=\"Media/Weapons/Weap_Wall_Render_03_resize.jpg\" width=\"140\" height=\"84\" class=\"myImages\" name=\"Image$i\" id=\"Image$i\" >
								</div>
						...
						echo "
							<div style=\"position: relative; float: left; width: 160px; height: 90px; z-index: 11;\">
								...
								<div style=\"position:absolute; top:1px; left:1px; z-index: 17;\">
								  <a href=\"Media/Weapons/Weap_Wall_Render_04.jpg\" rel=\"lightbox[media]\" onmouseout=\"unhighlightPic('Border$i')\" onmouseover=\"highlightPic('Border$i')\"><img src=\"images/blank.gif\" width=\"140\" height=\"90\" border=\"0\"  ></a>
								</div>
								...
								<div style=\"position:absolute; top:0px; left:0px; z-index: 13;\">
								  <img src=\"Media/Weapons/Weap_Wall_Render_04_resize.jpg\" width=\"140\" height=\"84\" class=\"myImages\" name=\"Image$i\" id=\"Image$i\" >
								</div>
			...
			<!--Table Bot-->
			<div style="position: relative; top: 0px; left: 0px; width: 778px; height: 74px;  background:url('images/MenuBG_Bot2b.png') no-repeat; z-index: 2;" >
